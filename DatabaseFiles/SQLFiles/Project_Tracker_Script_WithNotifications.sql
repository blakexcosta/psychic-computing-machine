...
-- -----------------------------------------------------
-- Table `project_tracker`.`user_notifications`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `project_tracker`.`user_notifications` ;
...
INSERT INTO `project_tracker`.`user` (`UserName`, `FirstName`, `LastName`, `Password`, `Image`, `GraduationDate`, `Department`, `Major`, `Role`) VALUES ('qz1234', 'Testie', 'Testerson', 'password', '', '2017-09-10', 'WMC grad student', 'WMC', 'Student');
...
INSERT INTO `project_tracker`.`email` (`UserName`, `EmailAddress`, `EmailType`) VALUES ('qz1234', 'qz1234@rit.edu', 'School');
...
INSERT INTO `project_tracker`.`phone` (`UserName`, `PhoneNumber`, `PhoneType`) VALUES ('qz1234', '', 'None');
...
-- Foreign Key
-- -----------------------------------------------------
ALTER TABLE milestone ADD FOREIGN KEY (ID) REFERENCES project_milestone_link(MilestoneID) ON UPDATE CASCADE ON DELETE CASCADE;